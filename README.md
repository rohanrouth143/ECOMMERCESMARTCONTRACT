...
struct Product{ string title; string desc; address payable seller; uint productId; uint price; address buyer; bool delivered; }
...
modifier isNotDestroyed{ require(!destroyed,"Contract does not exist");
 _; 
 }
